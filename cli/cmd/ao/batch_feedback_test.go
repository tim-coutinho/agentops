...
// Tests for probeWithExtensions, probeDirect, probeGlob, searchDirsForLearning,
// buildAgentsDirs, isInSet have been moved to cli/internal/resolver/resolver_test.go
// as part of the LearningResolver extraction.
